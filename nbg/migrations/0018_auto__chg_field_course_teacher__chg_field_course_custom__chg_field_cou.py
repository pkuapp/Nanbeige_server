...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.teacher'
        db.alter_column('nbg_course', 'teacher', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Course.custom'
        db.alter_column('nbg_course', 'custom', self.gf('django.db.models.fields.CharField')(default='', max_length=300))

        # Changing field 'Course.ta'
        db.alter_column('nbg_course', 'ta', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'UserProfile.weibo_name'
        db.alter_column('nbg_userprofile', 'weibo_name', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'UserProfile.nickname'
        db.alter_column('nbg_userprofile', 'nickname', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Campus.name'
        db.alter_column('nbg_campus', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

    def backwards(self, orm):

        # Changing field 'Course.teacher'
        db.alter_column('nbg_course', 'teacher', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Course.custom'
        db.alter_column('nbg_course', 'custom', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Course.ta'
        db.alter_column('nbg_course', 'ta', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'UserProfile.weibo_name'
        db.alter_column('nbg_userprofile', 'weibo_name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'UserProfile.nickname'
        db.alter_column('nbg_userprofile', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Campus.name'
        db.alter_column('nbg_campus', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'nbg.semester': {
            ...
            'excluded': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'university': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nbg.University']"}),
        ...
        'nbg.userprofile': {
            ...
            'university': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nbg.University']", 'null': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'}),
            'weibo_name': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'})
        },
        'nbg.wiki': {
