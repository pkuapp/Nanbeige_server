...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('nbg_course', 'teacher',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.ta'
        db.add_column('nbg_course', 'ta',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('nbg_course', 'teacher')

        # Deleting field 'Course.ta'
        db.delete_column('nbg_course', 'ta')
