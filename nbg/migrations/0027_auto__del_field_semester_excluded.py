...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Semester.excluded'
        db.delete_column('nbg_semester', 'excluded')


    def backwards(self, orm):
        # Adding field 'Semester.excluded'
        db.add_column('nbg_semester', 'excluded',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=100, blank=True),
                      keep_default=False)
