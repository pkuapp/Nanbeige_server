...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'University.lessons_separator'
        db.add_column('nbg_university', 'lessons_separator',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'University.lessons_separator'
        db.delete_column('nbg_university', 'lessons_separator')
    ...
    models = {
        ...
        'nbg.university': {
            ...
            'lessons_separator': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '50', 'null': 'True'}),
            'longitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '6'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
