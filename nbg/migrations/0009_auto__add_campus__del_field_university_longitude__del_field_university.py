...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('nbg', ['Campus'])

        # Deleting field 'University.longitude'
        db.delete_column('nbg_university', 'longitude')

        # Deleting field 'University.latitude'
        db.delete_column('nbg_university', 'latitude')


    def backwards(self, orm):
        # Deleting model 'Campus'
        db.delete_table('nbg_campus')

        # Adding field 'University.longitude'
        db.add_column('nbg_university', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=6),
                      keep_default=False)

        # Adding field 'University.latitude'
        db.add_column('nbg_university', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=6),
                      keep_default=False)
