...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('nbg', ['Semester'])

        # Adding field 'Course.semester'
        db.add_column('nbg_course', 'semester',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['nbg.Semester']),
                      keep_default=False)

        # Deleting field 'University.week_end'
        db.delete_column('nbg_university', 'week_end')

        # Deleting field 'University.week_start'
        db.delete_column('nbg_university', 'week_start')

        # Deleting field 'University.excluded'
        db.delete_column('nbg_university', 'excluded')


        # Changing field 'University.lessons_separator'
        db.alter_column('nbg_university', 'lessons_separator', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=1, max_length=50))

    def backwards(self, orm):
        # Deleting model 'Semester'
        db.delete_table('nbg_semester')

        # Deleting field 'Course.semester'
        db.delete_column('nbg_course', 'semester_id')

        # Adding field 'University.week_end'
        db.add_column('nbg_university', 'week_end',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 7, 27, 0, 0)),
                      keep_default=False)

        # Adding field 'University.week_start'
        db.add_column('nbg_university', 'week_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 7, 27, 0, 0)),
                      keep_default=False)

        # Adding field 'University.excluded'
        db.add_column('nbg_university', 'excluded',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=1, max_length=100),
                      keep_default=False)


        # Changing field 'University.lessons_separator'
        db.alter_column('nbg_university', 'lessons_separator', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True))
