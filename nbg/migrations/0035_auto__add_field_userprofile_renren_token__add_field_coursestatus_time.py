...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.renren_token'
        db.add_column('nbg_userprofile', 'renren_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'CourseStatus.time'
        db.add_column('nbg_coursestatus', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 9, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.renren_token'
        db.delete_column('nbg_userprofile', 'renren_token')

        # Deleting field 'CourseStatus.time'
        db.delete_column('nbg_coursestatus', 'time')
