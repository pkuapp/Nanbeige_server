...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('nbg_newsfeed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('news_type', self.gf('django.db.models.fields.IntegerField')()),
            ('ref_model', self.gf('django.db.models.fields.CharField')(max_length=55)),
            ('object_id', self.gf('django.db.models.fields.IntegerField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('info', self.gf('django.db.models.fields.CharField')(max_length=755, null=True)),
        ))
        db.send_create_signal('nbg', ['NewsFeed'])


    def backwards(self, orm):
        # Deleting model 'NewsFeed'
        db.delete_table('nbg_newsfeed')
