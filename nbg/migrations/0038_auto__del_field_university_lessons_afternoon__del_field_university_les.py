...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'University.lessons_afternoon'
        db.delete_column('nbg_university', 'lessons_afternoon')

        # Deleting field 'University.lessons_evening'
        db.delete_column('nbg_university', 'lessons_evening')

        # Deleting field 'University.lessons_morning'
        db.delete_column('nbg_university', 'lessons_morning')


    def backwards(self, orm):
        # Adding field 'University.lessons_afternoon'
        db.add_column('nbg_university', 'lessons_afternoon',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'University.lessons_evening'
        db.add_column('nbg_university', 'lessons_evening',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'University.lessons_morning'
        db.add_column('nbg_university', 'lessons_morning',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        'nbg.lesson': {
            ...
            'weekset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nbg.Weekset']", 'null': 'True', 'blank': 'True'})
        },
        'nbg.newsfeed': {
