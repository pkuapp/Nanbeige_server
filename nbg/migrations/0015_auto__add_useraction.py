...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('nbg_useraction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('semester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbg.Semester'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('action_type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('nbg', ['UserAction'])


    def backwards(self, orm):
        # Deleting model 'UserAction'
        db.delete_table('nbg_useraction')
