...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'University.support_ta'
        db.add_column('nbg_university', 'support_ta',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'University.support_ta'
        db.delete_column('nbg_university', 'support_ta')
