...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.renren_id'
        db.add_column('nbg_userprofile', 'renren_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.renren_name'
        db.add_column('nbg_userprofile', 'renren_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.renren_id'
        db.delete_column('nbg_userprofile', 'renren_id')

        # Deleting field 'UserProfile.renren_name'
        db.delete_column('nbg_userprofile', 'renren_name')
