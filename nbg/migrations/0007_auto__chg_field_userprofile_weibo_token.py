...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.weibo_token'
        db.alter_column('nbg_userprofile', 'weibo_token', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.weibo_token'
        db.alter_column('nbg_userprofile', 'weibo_token', self.gf('django.db.models.fields.CharField')(default=1, max_length=32))
    ...
    models = {
        ...
        'nbg.userprofile': {
            ...
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['nbg.Course']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'}),
            'weibo_token': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'})
        },
        'nbg.wiki': {
