...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.weibo_token'
        db.delete_column('nbg_userprofile', 'weibo_token')

        # Adding field 'UserProfile.weibo_name'
        db.add_column('nbg_userprofile', 'weibo_name',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.university'
        db.add_column('nbg_userprofile', 'university',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['nbg.University'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.weibo_token'
        db.add_column('nbg_userprofile', 'weibo_token',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.weibo_name'
        db.delete_column('nbg_userprofile', 'weibo_name')

        # Deleting field 'UserProfile.university'
        db.delete_column('nbg_userprofile', 'university_id')
    ...
    models = {
        ...
        'nbg.userprofile': {
            ...
            'university': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nbg.University']", 'blank': 'True'}),
