...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.weeks'
        db.delete_column('nbg_course', 'weeks')

        # Adding field 'Course.custom'
        db.add_column('nbg_course', 'custom',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.hash'
        db.add_column('nbg_course', 'hash',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=32),
                      keep_default=False)

        # Adding field 'Lesson.weeks'
        db.add_column('nbg_lesson', 'weeks',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=1, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.weeks'
        db.add_column('nbg_course', 'weeks',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=1, max_length=200),
                      keep_default=False)

        # Deleting field 'Course.custom'
        db.delete_column('nbg_course', 'custom')

        # Deleting field 'Course.hash'
        db.delete_column('nbg_course', 'hash')
    ...
    models = {
        ...
        'nbg.course': {
            ...
            'custom': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            ...
            'ta': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'teacher': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'nbg.event': {
        ...
        'nbg.userprofile': {
            ...
            'weibo_name': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'})
        },
        'nbg.wiki': {
