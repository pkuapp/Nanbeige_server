...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.university'
        db.alter_column('nbg_userprofile', 'university_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbg.University'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.university'
        db.alter_column('nbg_userprofile', 'university_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['nbg.University']))
