...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.weibo_id'
        db.alter_column('nbg_userprofile', 'weibo_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.weibo_id'
        db.alter_column('nbg_userprofile', 'weibo_id', self.gf('django.db.models.fields.IntegerField')(null=True))
