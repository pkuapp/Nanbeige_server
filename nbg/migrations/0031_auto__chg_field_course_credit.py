...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('nbg_course', 'credit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Course.credit'
        db.alter_column('nbg_course', 'credit', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=3, decimal_places=1))
