...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Weekset'
        db.create_table('nbg_weekset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('weeks', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=200)),
        ))
        db.send_create_signal('nbg', ['Weekset'])

        # Adding field 'Lesson.weekset'
        db.add_column('nbg_lesson', 'weekset',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbg.Weekset'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Weekset'
        db.delete_table('nbg_weekset')

        # Deleting field 'Lesson.weekset'
        db.delete_column('nbg_lesson', 'weekset_id')
