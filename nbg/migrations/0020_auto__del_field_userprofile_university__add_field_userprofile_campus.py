...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.campus'
        db.add_column('nbg_userprofile', 'campus',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbg.Campus'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('nbg_userprofile', 'university',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbg.University'], null=True),
                      keep_default=False)

        # Deleting field 'UserProfile.campus'
        db.delete_column('nbg_userprofile', 'campus_id')
