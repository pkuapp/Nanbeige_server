...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseStatus'
        db.create_table('nbg_coursestatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbg.UserProfile'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbg.Course'])),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('nbg', ['CourseStatus'])

        # Removing M2M table for field courses on 'UserProfile'
        db.delete_table('nbg_userprofile_courses')


    def backwards(self, orm):
        # Deleting model 'CourseStatus'
        db.delete_table('nbg_coursestatus')

        # Adding M2M table for field courses on 'UserProfile'
        db.create_table('nbg_userprofile_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['nbg.userprofile'], null=False)),
            ('course', models.ForeignKey(orm['nbg.course'], null=False))
        ))
        db.create_unique('nbg_userprofile_courses', ['userprofile_id', 'course_id'])
